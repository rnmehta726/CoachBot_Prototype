...
class TricepDip extends StatefulWidget {
  final List<CameraDescription> cameras;
  final String exercise;

  TricepDip(this.cameras, this.exercise);
  @override
  State<StatefulWidget> createState() => _TricepDipState();
}

class _TricepDipState extends State<TricepDip> {
